...
<div id="layoutSidenav_content">
  ...
  <h2 class="pull-left">Actividades </h2>
  </div>
  <div class="card-body">
                   ...
                   <?php
                    ...
                    <tr>
                      ...
                      <!--  <a href="update.php?id=<?php echo $row["id"]; ?>" class="btn btn-info pull-right">Editar</a>
                        ...
                        <a href="delete.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger pull-right">Eliminar</a>
                     

                    -->
Solo el usuario Administrador puede modificar las actividades
